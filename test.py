...
con=sqlite3.connect('database_211b147')
cur=con.cursor()
...
class bus_booking:
    ...
    def cover_page(self):
        ...
        Label(root,text='\n\n').pack()
        Label(root,text='Name : Ishatv Beohar',font='stylus 20 bold',fg='blue').pack()
        Label(root,text='\n').pack()
        Label(root,text='Er.no : 211B147',font='stylus 20 bold',fg='blue').pack()
        Label(root,text='\n').pack()
        Label(root,text='Number : 7470706580',font='stylus 20 bold',fg='blue').pack()
        Label(root,text='\n\n').pack()
